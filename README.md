...
## Project Structure
    ...
    ├── apps_subscription_p_31564  # Django project configurations
...
1. Clone this repo and `cd apps_subscription_p_31564`
...
2. Clone this repo and `cd apps_subscription_p_31564`
